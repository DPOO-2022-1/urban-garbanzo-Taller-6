...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(RENOMBRAR_CATEGORIA, "Renombrar el nombre de alguna categoria", "./data/iconos/renombrar.png");
		agregarBoton(BORRAR_LIBROS, "Borrar libros de autores xd", "./data/iconos/trashuwu.png");
	}
